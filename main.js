...
function up(){
    if(player_y>=0){
        ...
        console.log("The latitude of the player(X) is"+player_x+"and the longitude of the player(Y) is"+player_y);
...
function down(){
    if(player_y<=550){
        player_y=player_y+block_image_height;
        console.log("The height of 'block image' is"+block_image_height);
        console.log("The X of the player is"+player_x+"and the Y is"+player_y);
        canvas.remove(player_object);
        player_update();
    }
}
...
function left(){
    if(player_x>=0){
        ...
        console.log("The width of the block image="+block_image_width);
        console.log("the Y of the player is"+player_y+"and the X is"+player_x);
        canvas.remove(player_object);
        player_update();
    }
}
...
function right(){
    if (player_x<=900){
        player_x=player_x+block_image_width;
        console.log("the breadth of the block image is"+block_image_width);
        console.log("the X of the player is"+player_x+"and the Y of the player is"+player_y);
        canvas.remove(player_object);
        player_update();
    }
}
